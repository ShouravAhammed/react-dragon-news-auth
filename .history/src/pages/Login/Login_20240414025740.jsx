  ...
  <div className="hero-content">
    <div className="card  w-full max-w-sm shadow-2xl">
      ...
      <form className="card-body">
        ...
        <button
        className="w-full px-8 py-2.5 relative group overflow-hidden font-medium bg-white text-gray-800 inline-block border-gray-800 border"
      >
        <span className="absolute top-0 left-0 flex w-full h-0 mb-0 transition-all duration-200 ease-out transform translate-y-0 bg-gray-800 group-hover:h-full"></span>

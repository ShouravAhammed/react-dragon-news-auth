...
const Navbar = () => {
  ...
  <button
        className="px-8 py-2.5 relative group overflow-hidden font-medium bg-[#D72050] text-white inline-block"
      >
        ...
        <span className="relative group-hover:text-[#D72050]">Login</span>
      </button>
  </div>
</div>
        </div>

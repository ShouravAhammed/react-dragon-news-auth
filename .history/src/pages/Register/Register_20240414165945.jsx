    ...
    <div className="card rounded-none w-full max-w-sm shadow-2xl">
      ...
      <form className="card-body" onSubmit={handleRegister}>
        ...
        <div className="form-control">
          ...
          <input type={showPassword ? 'password' : 'text'} id="password" name="password" placeholder="password" className="input bg-[#F3F3F3] rounded-none" required />
          <span onClick={() => setShowPassword(!true)}>Show</span>
        </div>

    ...
    <div className="card rounded-none w-full max-w-sm shadow-2xl">
      ...
      <form className="card-body">
        ...
        <div className="form-control">
          ...
          <input type="text" id="name" name="name" placeholder="email" className="input rounded-none bg-[#F3F3F3]" required />
        </div>
        <div className="form-control">
          <label className="label">
        ...
        <div className="form-control"><label className="label">Accept Term & Conditions</label>
        <button
